...
class ScrollableKettlebellWidget extends StatelessWidget {
  ...
  const ScrollableKettlebellWidget({ Key? key, required this.kettleBellWorkout}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      return KettlebellWorkoutDetailWidget(
        ...
        title: kettleBellWorkout.groups[index].title,
...
class KettlebellWorkoutDetailWidget extends StatelessWidget {
  ...
  const KettlebellWorkoutDetailWidget({ required this.title, required this.work_rest}) ;
